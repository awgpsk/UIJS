...
Date.prototype.format=function(format)
{
	...
	var dd = (this.getDate()+"").padStart(2,"0");
	var mm = ((this.getMonth()+1)+"").padStart(2,"0");
	...
	var month_names =["Jan","Feb","Mar",
                      ...
                      "Jul","Aug","Sep",
					  "Oct","Nov","Dec"];
	var mon = month_names[this.getMonth()];
	...
	format = format.replace("RRRR",yyyy);
	format = format.replace("RR",yy);
	format = format.replace("MON",mon);
...
function Formats()
{
    ...
    this.formatIndianMoney=function(amount)
    {
		//var amt = round(amount,2);
		if(typeof amount == "undefined" || amount==null || amount == "")
		{
			return null;
		}
		var v = OSREC.CurrencyFormatter.format(amount, { currency: 'INR' }); 
